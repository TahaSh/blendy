...
export function borderRadiusSub(
  a: BorderRadius,
  b: BorderRadius
): BorderRadius {
  const x = {
    topLeft: a.x.topLeft - b.x.topLeft,
    topRight: a.x.topRight - b.x.topRight,
    bottomRight: a.x.bottomRight - b.x.bottomRight,
    bottomLeft: a.x.bottomLeft - b.x.bottomLeft
  }

  const y = {
    topLeft: a.y.topLeft - b.y.topLeft,
    topRight: a.y.topRight - b.y.topRight,
    bottomRight: a.y.bottomRight - b.y.bottomRight,
    bottomLeft: a.y.bottomLeft - b.y.bottomLeft
  }

  return { x, y, unit: a.unit }
}
